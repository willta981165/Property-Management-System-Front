...
function isLoginUser(value: unknown): value is LoginUser {
  ...
  return (
    ...
    isOptionalString(user["employee_id"]) &&
    isOptionalString(user["unit_code"]) &&
    isOptionalString(user["unit"]) &&
    isOptionalString(user["phone"]) &&
    isOptionalString(user["email"]) &&
    isOptionalString(user["department"]) &&
    isOptionalString(user["project_name"]) &&
    isOptionalBoolean(user["is_active"]) &&
